...
// this.dadosDetalhamentoMedicoComID =
// criarDadosDetalhamentoComId(idMedicoMock);
// this.dadosAtualizacaoMedico = criarDadosAtualizacao(idMedicoMock);
// }

// @Test
// @DisplayName("cadastrar - Deve devolver codigo HTTP 400 quando informacoes
// estao invalidas")
// @WithMockUser
...
// @Test
// @DisplayName("cadastrar - Deve devolver codigo HTTP 200 quando informacoes
// estao validas")
// @WithMockUser
...
// var jsonEsperado =
// dadosDetalhamentoMedicoJson.write(this.dadosDetalhamentoMedico).getJson();
...
// @Test
// @DisplayName("detalhar - Deve devolver codigo HTTP 200 quando o id passado é
// válido")
// @WithMockUser
...
// idMedicoMock).contentType(MediaType.APPLICATION_JSON))
// .andReturn().getResponse();
// var jsonEsperado =
// dadosDetalhamentoMedicoJson.write(dadosDetalhamentoMedicoComID).getJson();
...
// @Test
// @DisplayName("escluir - Deve retornar Http codigo 204 quando passado um id
// válido")
// @WithMockUser
// public void excluir() throws Exception {
// Mockito.when(medicoService.excluir(idMedicoMock)).thenReturn(dadosDetalhamentoMedicoComID);
...
// @Test
// @DisplayName("atualizar - Deve retornar Http codigo 400 quando informacoes
// passadas estão invalidas")
// @WithMockUser
// public void atualizarCenario1() throws Exception {
// var response = mvc.perform(
// MockMvcRequestBuilders.put(baseUrl).contentType(MediaType.APPLICATION_JSON)).andReturn().getResponse();

// Assertions.assertThat(response.getStatus()).isEqualTo(HttpStatus.BAD_REQUEST.value());
// }

// @Test
// @DisplayName("atualizar - Deve retornar Http codigo 200 quando informações
// passadas estão válidas")
// @WithMockUser
// public void atualizarCenario2() throws Exception {
// Mockito.when(this.medicoService.atualizarInformacoes(dadosAtualizacaoMedico))
// .thenReturn(dadosDetalhamentoMedicoComID);
// var jsonEsperado =
// dadosDetalhamentoMedicoJson.write(dadosDetalhamentoMedicoComID).getJson();
...
// return new DadosEndereco("Rua Exemplo", "Bairro", "12345123", "Cidade", "RJ",
// null, null);
// }

// private DadosDetalhamentoMedico criarDadosDetalhamento() {
// var dadosCadastro = criarDadosCadastro();
// var dadosDetalhamento = new DadosDetalhamentoMedico(null, "Fernando",
// "fernando@email.com", "123456",
// "21123451234", dadosCadastro.especialidade(), new
...
// var dadosCadastro = criarDadosCadastro();
// var dadosDetalhamento = new DadosDetalhamentoMedico(id, "Fernando",
// "fernando@email.com", "123456",
// "21123451234", dadosCadastro.especialidade(), new
// Endereco(dadosCadastro.endereco()));
...
// var dadosCadastro = new DadosCadastroMedico("Fernando", "fernando@email.com",
// "21123451234", "123456",
// dadosEspecialidade, dadosEndereco);

// return dadosCadastro;
// }

// private DadosAtualizacaoMedico criarDadosAtualizacao(Long idMedicoMock) {
// return new DadosAtualizacaoMedico(idMedicoMock, "Fernando", "21123451234",
// criarEndereco());
// }
// }
